...
match '/new', to: 'inquiries#new', via: 'get'
  ...
  match '/about', to: 'young_empowered#about', via: 'get'
   ...
   match '/join_us', to: 'young_empowered#join_us', via: 'get'
   match '/newsandevents', to: 'young_empowered#newsandevents', via: 'get'
   match '/stories', to: 'young_empowered#stories', via: 'get'
